...
export default function Admin(){const router=useRouter(),[rows,setRows]=useState<Pay[]>([]),[msg,setMsg]=useState("");
 ...
 useEffect(()=>onAuthStateChanged(auth,u=>{if(!u||!isAdminEmail(u.email))return router.push("/login");load()}),[router]);
